...
const Home = () => {
  ...
  return (
    <div className="bg-[#242424] h-screen">
      <motion.h1
        className="text-3xl font-bold text-white p-6 uppercase"
      ...
      <div className="flex items-center flex-col justify-center h-screen">
        ...
        <div className="flex items-center justify-center px-24">
          ...
          >
            ...
            sed ligula imperdiet venenatis. Morbi nisl mauris, hendrerit in
            ...
            facilisi. Etiam bibendum mollis lorem, vitae pharetra ex tempus et.
            Proin dictum sapien id odio pharetra, sed lobortis quam ullamcorper.
            Duis lacinia, eros eu finibus lacinia, nisi diam imperdiet neque, ut
            vehicula quam nunc nec sapien. Praesent mi tortor, ornare id erat
            id, gravida facilisis ex. Sed sollicitudin quam non felis tempor
            condimentum.
          </motion.p>
          <motion.p
            className="text-white p-6"

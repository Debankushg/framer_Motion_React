      ...
      <div className="container mx-auto bg-[#242424] p-6 rounded-lg shadow-lg">
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="w-full lg:w-1/3">
            <div className="bg-gradient-to-br from-[#242424] via-[#685c5c] to-[#343434] rounded-xl p-8 shadow-xl max-w-sm mx-auto">
              ...
              <div className="mt-8 flex flex-col gap-3">
                <button
                  className={`py-3 px-5 rounded-lg text-left font-semibold text-sm transition-colors duration-300 ease-in-out cursor-pointer
        ${
        ...
        ${
          ...
          <div className="w-full lg:w-2/3">
            {activeSection === "profileDetails" && (
              <div className="bg-gradient-to-br from-[#242424] via-[#685c5c] to-[#343434]  rounded-xl p-8 shadow-lg mx-auto">
                <h5 className="text-2xl font-extrabold mb-6 text-indigo-400 border-b-2 border-indigo-600 pb-2">
                  Profile Information
                </h5>
                <div className="space-y-4 text-gray-200 grid grid-cols-2 text-md">
                  <p>
